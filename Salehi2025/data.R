...
# Calculate Shannon diversity index directly using mia's built-in support
tse_class_top5 <- addAlpha(
  tse_class_top5,
...
adult_metadata$sex_num_Men <- ifelse(adult_metadata$gender == "Men", 0, 1)
