...
This benchmarking was conducted in a separate R script (`StanBackendComparison.R`). Please ensure that this script is available in your working directory. The results have been saved as `.rds` files and are loaded here to enable downstream analysis.
