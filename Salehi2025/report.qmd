...
# Make sure factors match model levels
newdata$income_group <- factor(newdata$income_group, 
                               levels = levels(fit_enrichment_age_hier[["all"]]$data$income_group))
newdata$age_category <- factor(newdata$age_category, 
                               levels = levels(fit_enrichment_age_hier[["all"]]$data$age_category))
...
# Make sure factors match model levels
newdata$income_group <- factor(newdata$income_group, 
                               levels = levels(fit_enrichment_gender_hier[["all"]]$data$income_group))
newdata$gender <- factor(newdata$gender, 
                         levels = 
levels(fit_enrichment_gender_hier[["all"]]$data$gender))
...
# Make sure factors match model levels
newdata$income_group <- factor(newdata$income_group, 
                               levels = levels(fit_enrichment_age_gender_hier[["all"]]$data$income_group))
newdata$gender <- factor(newdata$gender, 
                         levels = levels(fit_enrichment_age_gender_hier[["all"]]$data$gender))
newdata$age_category <- factor(newdata$age_category, 
                               levels = levels(fit_enrichment_age_gender_hier[["all"]]$data$age_category))
...
```{r, include=FALSE}
# Load saved hierarchical model (with slopes, no gender)
...
# Make sure factors match model levels
newdata$continent <- factor(newdata$continent, 
                            levels = levels(fit_enrichment_age_continent_hier[["all"]]$data$continent))
newdata$age_category <- factor(newdata$age_category, 
                               levels = levels(fit_enrichment_age_continent_hier[["all"]]$data$age_category))
...
```{r, include=FALSE}
# Load saved hierarchical model (simplified)
...
# Make sure factors match model levels
newdata$continent <- factor(newdata$continent, 
                            levels = levels(fit_enrichment_income_age_gender_continent_hier[["all"]]$data$continent))
newdata$income_group <- factor(newdata$income_group, 
                               levels = levels(fit_enrichment_income_age_gender_continent_hier[["all"]]$data$income_group))
newdata$gender <- factor(newdata$gender, 
                         levels = levels(fit_enrichment_income_age_gender_continent_hier[["all"]]$data$gender))
newdata$age_category <- factor(newdata$age_category, 
                               levels = levels(fit_enrichment_income_age_gender_continent_hier[["all"]]$data$age_category))

# Posterior expected prevalence
posterior_preds <- posterior_epred(fit_enrichment_income_age_gender_continent_hier[["all"]], newdata = newdata)
...
```{r, include=FALSE}
# Load saved hierarchical model (with slopes, all groups)
...
newdata$continent <- factor(newdata$continent, 
                            levels = levels(fit_enrichment_all_hier[["all"]]$data$continent))
newdata$income_group <- factor(newdata$income_group, 
                               levels = levels(fit_enrichment_all_hier[["all"]]$data$income_group))
newdata$gender <- factor(newdata$gender, 
                         levels = levels(fit_enrichment_all_hier[["all"]]$data$gender))
newdata$age_category <- factor(newdata$age_category, 
                               levels = levels(fit_enrichment_all_hier[["all"]]$data$age_category))
